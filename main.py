...
app = Flask(__name__)
app.config['SECRET_KEY'] = "783011e9bd1b0d150898e25d9913260b4ca275546cc825b4518ac688a79d1650"
...
class BlogPost(db.Model):
    ...
    # author = db.Column(db.String(250), nullable=False) ## Instead Create reference to the User object
